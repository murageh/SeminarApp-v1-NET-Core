...
public class Credentials
{
    ...
    public SeminarIntegration_PortClient ObjNav()
    {
        ...
        var endpointAddress =
            new EndpointAddress(
                "http://murageh:7047/BC240/WS/CRONUS%20International%20Ltd./Codeunit/SeminarIntegration");

        // Instantiate the service client with the binding and endpoint
        return new SeminarIntegration_PortClient(binding, endpointAddress);
    }
}